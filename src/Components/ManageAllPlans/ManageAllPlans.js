...
const ManageAllPlans = () => {
    ...
    useEffect(() => {
        fetch("https://desolate-reaches-42865.herokuapp.com/managePlans")
        .then(res => res.json())
        .then(data => setOrders(data))
    },[control])

    const handleUpdate = (id) =>{
      fetch(`https://desolate-reaches-42865.herokuapp.com/updateStatus/${id}`, {
        method: "PUT",
    ...
    const handleDelete = (id)=>{
      ...
      if(proceed){
       fetch(`https://desolate-reaches-42865.herokuapp.com/deteteOrders/${id}`, {
           method: 'DELETE'
       })
       .then(res => res.json())
       .then(data =>{
